...
// ─── Page imports (for inline Profile + Save tabs) ────────────────────────────
      ...
      <div className="flex gap-1 rounded-2xl p-1 mb-5 bg-slate-100">
        {[
          ...
          <button
            ...
            style={{
              background: section === tab.key ? '#ffffff' : 'transparent',
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  style={{ fontSize: 10, marginTop: 3, color: '#94a3b8' }}
                >
                  {tab.label}
                </span>
              </button>
...
export default function AppLayout() {
  ...
  // Derive active tab from URL on mount
  React.useEffect(() => {
    const p = location.pathname;
    if (['/Stores', '/Rewards', '/Profile'].includes(p)) { setActiveTab('profile'); }
