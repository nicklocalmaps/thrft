...
export default function AppLayout() {
  ...
  const navItems = [
    { path: '/Home',    label: 'My Lists', icon: ThrftCartIcon },
      ...
      >
        ...
        <Link
          ...
          style={{
            ...
            width: 36, height: 36, borderRadius: 10, backgroundColor: THRFT_BLUE, flexShrink: 0,
          }}
        >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  justifyContent: 'center', gap: 3, height: 60,
